<x-panel.dash>
    <div class="container-fluid">
        <x-panel.user-modal-button title="Edit Job" />
        ...
        <div class="row">
            <form action="/super-admin/jobs/{{ $job->id }}/update" method="POST" class="col-xl-12">
                @csrf
                @method("PATCH")
                ...
                <div class="card-body bg-light border ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="title"
                                            placeholder="Eg: LECTURER (TELECOMMUNICATIONS ENGINEERING)"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="tags"
                                            placeholder="eg: software, hardware, " value="{{ old('tags', $tags) }}"
                                            name="tags">
                                        @error('tags')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="company">
                                            <option value="{{ $job->employer->id }}">{{ $job->employer->company_name }}
                                            </option>
                                        </select>
                                        @error('company')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="positions" placeholder="Eg: 2"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Summary of the job position......."
                                        rows="3" name="description">{{ old('description', $job->description) }}"</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="mt-3 col-6 mx-auto">
                        <button type="submit" class="btn btn-secondary btn-lg btn-block mb-1">Update Job</button>
                    </div>
                </div>
